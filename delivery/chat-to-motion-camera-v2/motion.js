...
function seek(t){t=clamp(t,0,DURATION);reset();applyCamera(camBeat(t));
  ...
  const chatOut=smooth(seg(t,5.45,6.18));show(chat,1-chatOut);show(cursor,1-smooth(seg(t,5.08,5.5)));
  ...
  const hB=out3(seg(t,8.0,8.35))*(1-smooth(seg(t,8.82,9.12)));show(heroB,hB);tf(heroB,0,mix(32,0,out3(seg(t,8.0,8.35))),1,0);
