...
test('Remotion bridge boots OPENER by explicitly replaying scene scripts inside an isolated iframe', async () => {
  ...
  assert.match(bridge, /const bootScene = async/);
  assert.match(bridge, /new DOMParser\(\)\.parseFromString/);
